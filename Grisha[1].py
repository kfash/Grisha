...
А=list()
A0=line(390, 336, 360, 333)
A.append(A0)
A1=line(403, 333, 378, 335)
A.append(A1)
A2=line(407, 320, 362, 325)
A.append(A2)
A3=line(403, 325, 365, 332)
A.append(A3)
A4=line(404, 315, 370, 318)
A.append(A4)
A5=line(411, 310, 374, 312)
A.append(A5)
A6=line(425, 302, 372, 308)
A.append(A6)
A7=line(440, 296, 381, 301)
A.append(A7)
A8=line(444, 290, 399, 294)
A.append(A8)
...
def fur():
	...
	if i%3==0:
		...
		A[0]=line(390, 336, 360, 333)
		penColor(150, randint(150, 255), 150)
		A[1]=line(403, 333, 378, 335)
		penColor(100, 100, randint(150, 255))
		A[2]=line(407, 320, 362, 325)
		penColor(randint(150, 255), 150, 150)
		A[3]=line(403, 325, 365, 332)
		penColor(150, randint(150, 255), 150)
		A[4]=line(404, 315, 370, 318)
		penColor(100, 100, randint(150, 255))
		A[5]=line(411, 310, 374, 312)
		penColor(randint(150, 255), 150, 150)
		A[6]=line(425, 302, 372, 308)
		penColor(150, randint(150, 255), 150)
		A[7]=line(440, 296, 381, 301)
		penColor(100, 100, randint(150, 255))
		A[8]=line(444, 290, 399, 294)
	if i%3==1:
		penColor(100, 100, randint(150, 255))
		A[0]=line(390, 336, 360, 333)
		penColor(randint(150, 255), 150, 150)
